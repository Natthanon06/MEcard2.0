...
function ExchangeContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24 relative">
      ...
      {/* ✅ Scan Button (ปุ่มลอยมุมขวาล่าง แบบเกาะขอบจอ ไม่สนใจ Container) */}
      <Link 
        href="/scan" 
        className="fixed bottom-24 right-4 z-50 bg-black text-white p-4 rounded-full shadow-2xl hover:scale-105 transition-transform flex items-center gap-2"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
