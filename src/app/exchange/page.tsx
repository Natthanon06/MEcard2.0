...
function ExchangeContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <Link href="/scan" className="fixed bottom-24 right-6 bg-black text-white p-4 rounded-full shadow-2xl hover:scale-105 transition-transform flex items-center gap-2 z-50">
