...
export default function ProfilePage() {
  ...
  const currentStatus = user ? (STATUS_OPTIONS.find(s => s.id === user.status) || STATUS_OPTIONS[0]) : STATUS_OPTIONS[0];

  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      
      {/* ✅ Navbar (วางไว้นอกเงื่อนไข isLoading เพื่อให้โชว์ตลอดเวลา) */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                {/* ถ้ายังโหลด User ไม่เสร็จ ให้โชว์กลมๆ ว่างๆ ไปก่อน */}
      ...
      {/* ✅ ส่วนเนื้อหา: ถ้า isLoading ให้หมุนแค่ตรงนี้ / ถ้าเสร็จแล้วโชว์เนื้อหา */}
      {isLoading ? (
